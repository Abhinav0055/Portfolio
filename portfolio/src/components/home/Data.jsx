...
function Data() {
    return (
        <div className="home__data">
            <h1 className="home__title">Abhinav Rawat
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <h3 className="home__subtitle">CSE Engineer</h3>
            <p className="home__description">Im a 3rd CSE Student who studies in Chitkara University and I'm very
                passionate about Web Dev and App Dev and is dedicated to my work.</p>
